...
contract JBPaymentTerminalStore is IJBPaymentTerminalStore, ReentrancyGuard {
  ...
  */
    ...
    )
  {
    ...
    uint256 _weightRatio = _amount.currency == _baseWeightCurrency //_amount.currency=1, _baseWeightCurrency=1
      ? 10**_decimals  //1e18
      : prices.priceFor(_amount.currency, _baseWeightCurrency, _decimals); //_amount.currency=2, _baseWeightCurrency=1
